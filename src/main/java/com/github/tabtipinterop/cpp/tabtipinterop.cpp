...
JNIEXPORT void JNICALL Java_com_github_tabtipinterop_TabTipInterop_openTabTip(JNIEnv* env, jclass jclazz) {
    openTabTip();
}

JNIEXPORT void JNICALL Java_com_github_tabtipinterop_TabTipInterop_closeTabTip(JNIEnv* env, jclass jclazz) {
    closeTabTip();
}
